 ...
 */
package com.foudroyantfactotum.mod.fousarchive.structure.net;
...
public class StructurePacket implements IMessage
{
    ...
    public static class Handler implements IMessageHandler<StructurePacket, IMessage>
    {
        ...
        public IMessage onMessage(StructurePacket msg, MessageContext ctx)
        {
            ...
            final BlockStructure block = StructureRegistry.getStructureBlock(msg.structureHash);
            ...
            if (msg.sc == StructurePacketOption.BUILD)
            {
                ...
                BlockStructure.updateExternalNeighbours(world, msg.pos, block.getPattern(), orientation, mirror, true);
            ...
            {
                final BlockPos coord = BlockStructure.bindLocalToGlobal(
                        msg.pos, local,
                        orientation, mirror,
