...
public abstract class TEStructure extends FCAA_TE implements ITEStructure, IStructureSidedInventory, IStructureFluidHandler
{
    ...
    public TEStructure(StructureDefinition sd, EnumFacing orientation, boolean mirror)
    {
    ...
    public AxisAlignedBB getRenderBoundingBox()
    {
        ...
        {
            final BlockStructure sb = getMasterBlockInstance();
            ...
            renderBounds = Optional.of(TransformLAG.localToGlobalBoundingBox(pos, local, sb.getPattern(), orientation, mirror));
        }
    ...
    {
        return (flag & TransformLAG.flagEnumFacing(d)) != 0;
    }
