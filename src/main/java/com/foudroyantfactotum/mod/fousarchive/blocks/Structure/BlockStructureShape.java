...
import static com.foudroyantfactotum.mod.fousarchive.structure.coordinates.TransformLAG.localToGlobalCollisionBoxes;
...
public class BlockStructureShape extends FA_Block implements ITileEntityProvider
{
    ...
    public BlockStructureShape()
    {
        ...
        setDefaultState(this.blockState
                ...
                .withProperty(BlockStructure.MIRROR, false)
        );
    }
    ...
    {
        return new BlockState(this, FACING, BlockStructure.MIRROR);
    }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return getDefaultState()
                ...
                .withProperty(BlockStructure.MIRROR, mirror);
    }

    public int getMetaFromState(IBlockState state)
    {
        final EnumFacing facing = state.getValue(FACING);
        final boolean mirror = state.getValue(BlockStructure.MIRROR);
    ...
    public boolean removedByPlayer(World world, BlockPos pos, EntityPlayer player, boolean willHarvest)
    {
        ...
        if (sb != null)
        {
            ...
            BlockStructure.updateExternalNeighbours(world,
                    te.getMasterBlockLocation(),
                    sb.getPattern(),
                    state.getValue(FACING),
                    state.getValue(BlockStructure.MIRROR),
    ...
    {
        BlockStructure.onSharedNeighbourBlockChange(world, pos,
