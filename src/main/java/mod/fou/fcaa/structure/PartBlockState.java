...
public class PartBlockState implements IPartBlockState
{
    ...
    final ImmutableList<IProperty> indefinite;

    final IBlockState block;

    private PartBlockState(ImmutableMap<IProperty, Comparable> definitive, ImmutableList<IProperty> indefinite, IBlockState block)
    {
    ...
    public ImmutableList<IProperty> getIndefinite()
    {
        return indefinite;
    }
