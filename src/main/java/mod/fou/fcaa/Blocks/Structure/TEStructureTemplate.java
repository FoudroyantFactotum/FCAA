...
public abstract class TEStructureTemplate extends TEStructure
{

    public TEStructureTemplate()
    {
        //noop
    }

    public TEStructureTemplate(StructureDefinition sd, EnumFacing orientation, boolean mirror)
    {
